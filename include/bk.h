...
const unsigned char mcu_cmd_next[] = {0x55, 0xaa, 0x08, seq_bit, 0x0c, 0x01, 0x03, crc_bit};
#define mcu_cmd_next_str "player cmd next-song"

const unsigned char mcu_cmd_pre[] = {0x55, 0xaa, 0x08, seq_bit, 0x0c, 0x01, 0x04, crc_bit};
